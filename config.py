...
ASSUSERNAME = getenv("ASSUSERNAME", "kiyosie")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/xaikole/Iko-Music.git")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AOFCBOTXAIKO")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/CATI_TEMAN_RANDOM_PACAR")
